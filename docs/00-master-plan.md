...
| Auth | **Custom**, all four realms in `apps/api` | We were already building three of the four ourselves — customer token, staff device+PIN, admin WebAuthn. Buying a vendor for the fourth was not worth the lock-in. [ADR-0002] |
