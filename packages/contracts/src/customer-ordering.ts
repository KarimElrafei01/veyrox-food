...
/**
 * F1 — Customer ordering. Contracts for the `/public/*` endpoints
 * (docs/features/F1-customer-ordering/). Requests carry IDs and quantities only —
 * there is no price field anywhere, by construction (F1.3 §1).
 */
